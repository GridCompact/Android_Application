...
import com.example.practicetodomanager.R;
import com.example.practicetodomanager.model.Note;
import com.example.practicetodomanager.screens.main.details.NoteDetailsActivity;
...
public class Adapter extends RecyclerView.Adapter<Adapter.NoteViewHolder> {
    ...
    public NoteViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType){
        return new NoteViewHolder(
                LayoutInflater.from(parent.getContext()).inflate(R.layout.item_notelist,parent,false ));
